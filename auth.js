...
// 🔥 TOAST SYSTEM (DIV NECESSÁRIA: #custom-toast)
  ...
  loginBtn.addEventListener("click", async () => {
    ...
    try {
      ...
      showToast(
        "success",
        "BEM-VINDO",
        `Login efetuado com sucesso, ${user.displayName}`
      );
      ...
      if (erro) {
        ...
        erro.innerText = "⚠ Erro ao iniciar sessão.";
      }
...
// 🔥 ESTADO GLOBAL (TODAS AS PÁGINAS)
